Rails.application.routes.draw do
  ...
  get 'search_artist' => 'ajax#search_by_artist'  , :as => :search_by_artist
  get 'add_song' => 'ajax#add_song'
  get 'add_song_to_track' => 'ajax#add_song_to_track'
